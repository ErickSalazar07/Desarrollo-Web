...
public class Droga {
  ...
  @Column(nullable = false, name = "unidad_venidad")
  private Integer unidadVendida;

  @OneToMany(mappedBy = "drogaAsignada", cascade = CascadeType.ALL)
  private List<Tratamiento> tratamientos;

  public Droga(String nombre, Integer precioCompra, Integer precioVenta, Integer unidadDisponible,
  Integer unidadVendida) {
    this.nombre = nombre;
