...
public class DatabaseInit implements ApplicationRunner {
  ...
  public void run(ApplicationArguments args) throws Exception {
    ...
    repositorioMascota.save(new Mascota("Rocky", "Perro", 4, 7.2, "Parvovirus",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p2.png?raw=true",true));
    repositorioMascota.save(new Mascota("Bruno", "Perro", 1, 4.1, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p3.png?raw=true",true));
    repositorioMascota.save(new Mascota("Toby", "Perro", 5, 6.8, "Moquillo",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p4.png?raw=true",true));
    repositorioMascota.save(new Mascota("Simba", "Perro", 3, 5.0, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p5.png?raw=true",true));
    repositorioMascota.save(new Mascota("Luna", "Perro", 2, 4.5, "Gastroenteritis",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p6.png?raw=true",true));
    repositorioMascota.save(new Mascota("Coco", "Perro", 6, 8.3, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p7.png?raw=true",true));
    repositorioMascota.save(new Mascota("Milo", "Perro", 4, 6.2, "Otitis",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p8.png?raw=true",true));
    repositorioMascota.save(new Mascota("Duke", "Perro", 3, 7.0, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p9.png?raw=true",true));
    repositorioMascota.save(new Mascota("Rex", "Perro", 1, 5.5, "Sarna",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p10.png?raw=true",true));
    repositorioMascota.save(new Mascota("Thor", "Perro", 5, 9.1, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p11.png?raw=true",true));
    repositorioMascota.save(new Mascota("Bobby", "Perro", 2, 6.0, "Leptospirosis",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p12.png?raw=true",true));
    repositorioMascota.save(new Mascota("Zeus", "Perro", 4, 7.4, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p13.png?raw=true",true));
    repositorioMascota.save(new Mascota("Firulais", "Perro", 3, 5.9, "Gingivitis",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p14.png?raw=true",true));
    repositorioMascota.save(new Mascota("Sultan", "Perro", 6, 8.5, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p15.png?raw=true",true));
    repositorioMascota.save(new Mascota("Balto", "Perro", 1, 4.7, "Dermatitis",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p16.png?raw=true",true));
    repositorioMascota.save(new Mascota("Chester", "Perro", 3, 6.5, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p17.png?raw=true",true));
    repositorioMascota.save(new Mascota("Jack", "Perro", 2, 5.2, "Infección Urinaria",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p18.png?raw=true",true));
    repositorioMascota.save(new Mascota("Baxter", "Perro", 4, 7.0, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p19.png?raw=true",true));
    repositorioMascota.save(new Mascota("Spike", "Perro", 5, 8.0, "Otitis",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p20.png?raw=true",true));
    repositorioMascota.save(new Mascota("Hugo", "Perro", 3, 6.1, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p21.png?raw=true",true));
    repositorioMascota.save(new Mascota("Benji", "Perro", 2, 4.9, "Parásitos Intestinales",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p22.png?raw=true",true));
    repositorioMascota.save(new Mascota("Tommy", "Perro", 6, 9.2, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p23.png?raw=true",true));
    repositorioMascota.save(new Mascota("Lucas", "Perro", 1, 4.3, "Alergias",
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p24.png?raw=true",true));
    repositorioMascota.save(new Mascota("Rocco", "Perro", 4, 7.3, null,
        "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/p25.png?raw=true",true));
...
repositorioMascota.save(new Mascota("Leo", "Gato", 4, 3.9, "Infección urinaria", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/6g.png?raw=true",true));
repositorioMascota.save(new Mascota("Luna", "Gato", 3, 4.5, "Dermatitis", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/7g.png?raw=true",true));
repositorioMascota.save(new Mascota("Salem", "Gato", 2, 4.3, "Otitis", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/8g.png?raw=true",true));
repositorioMascota.save(new Mascota("Max", "Gato", 5, 4.1, "Toxoplasmosis", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/9g.png?raw=true",true));
repositorioMascota.save(new Mascota("Garfield", "Gato", 7, 5.5, "Obesidad", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/10g.png?raw=true",true));
repositorioMascota.save(new Mascota("Tom", "Gato", 3, 4.0, "Rabia", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/11g.png?raw=true",true));
repositorioMascota.save(new Mascota("Rocky", "Gato", 6, 4.4, "Epilepsia", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/12g.png?raw=true",true));
...
repositorioMascota.save(new Mascota("Chester", "Gato", 5, 4.8, "Diabetes", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/18g.png?raw=true",true));
repositorioMascota.save(new Mascota("Rayo", "Gato", 3, 4.3, "Alergias", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/19g.png?raw=true",true));
repositorioMascota.save(new Mascota("Otto", "Gato", 4, 4.5, "Conjuntivitis", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/20g.png?raw=true",true));
repositorioMascota.save(new Mascota("Minnie", "Gato", 3, 4.2, "Enfermedad del tracto urinario", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/21g.png?raw=true",true));
repositorioMascota.save(new Mascota("Nube", "Gato", 6, 4.6, "Insuficiencia hepática", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/22g.png?raw=true",true));
repositorioMascota.save(new Mascota("Kira", "Gato", 4, 4.3, "Cáncer", 
    "https://github.com/ErickSalazar07/Web/blob/main/imagenes/mascotas/23g.png?raw=true",true));
