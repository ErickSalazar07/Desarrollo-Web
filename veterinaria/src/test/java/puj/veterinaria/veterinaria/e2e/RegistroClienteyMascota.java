...
import org.bouncycastle.pqc.jcajce.provider.xmss.XMSSMTSignatureSpi.withShake128;
...
public class RegistroClienteyMascota {
    ...
    public void SystemTest_registroClienteyMascota_MascotaCreada(){
        ...
        WebElement ingresarButton = driver.findElement(By.xpath("//*[@id=\"contenedor_info\"]//div[2]//section//form//button"));
        ...
        WebElement clientesButton = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//*[@id=\"clientes\"]")));
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//html//body//app-root//app-crear-mascota//app-formulario-mascota//form//div//button")));
        ...
        WebElement crearMascotaButton = driver.findElement(By.xpath("//html//body//app-root//app-crear-mascota//app-formulario-mascota//form//div//button"));
        ...
        WebElement ingresarLoginButton = driver.findElement(By.xpath("//*[@id=\"contenedor_info\"]//div[2]//section//form//button"));
